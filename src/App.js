      ...
      <div className="App">
        ...
        <div style={styles.container}>
          <div style={styles.toolBar}>
            ...
            <div style={styles.controlTools}>
              ...
              <button style={styles.controlButton}
                onClick={() => {
                  if (selectedFile) {
                    const newFiles = myFiles.filter(file =>
          ...
          <div style={styles.fileContainer}>
            <div style={{ width: "60%", padding: 10, marginLeft: 30 }}>
              {myFiles.map((file) => {
            ...
            {selectedFile && (
              <div style={styles.fileViewer}>
                ...
                {selectedFile.type === 'document' && (
                  <DocumentViewer path={selectedFile.path} id={selectedFile.name} />
                )}
                {selectedFile.type === 'image' && (
                  <ImageViewer path={selectedFile.path} id={selectedFile.name} />
                )}
            ...
            {!selectedFile && (
              <div style={styles.visualiser}>
                <FontAwesomeIcon icon={faEye} size='2xl'/>
                <p style={{ fontWeight: "bold", marginTop: 10 }}>File preview</p>
              </div>
            )}
          </div>
        </div>
